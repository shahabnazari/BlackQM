...
export class CollaborationController {
  ...
  @ApiResponse({
    ...
    description: 'Returns list of collaborators',
  })
  ...
  async resolveComment(
    ...
    await this.collaborationService.resolveComment(
      studyId,
      commentId,
      req.user.id,
    );
  ...
  async getUserPermissions(
    ...
    return await this.collaborationService.getUserPermissions(
      studyId,
      req.user.id,
    );
  }
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Returns permission status',
  })
  ...
  async unlockSection(
    ...
    await this.collaborationService.handleSectionUnlock(
      studyId,
      body.sectionId,
    );
    return { success: true };
