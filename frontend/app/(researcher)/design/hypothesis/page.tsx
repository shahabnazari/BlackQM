...
const HYPOTHESIS_TEMPLATES: HypothesisTemplate[] = [
  {
    ...
    type: 'alternative',
    template:
      'There will be a significant difference in [DEPENDENT_VAR] between [GROUP_1] and [GROUP_2]',
    examples: [
    ...
    fields: [
      ...
      {
        name: 'group_2',
        placeholder: 'Second group/condition',
        required: true,
      },
    ],
  },
  {
    ...
    type: 'alternative',
    template:
      'There will be a [DIRECTION] relationship between [VAR_1] and [VAR_2]',
    examples: [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'effect',
        placeholder: 'increase/decrease/improve/reduce',
        required: true,
      },
      {
        name: 'dependent_variable',
  ...
  },
  {
    ...
    type: 'alternative',
    template:
      'The relationship between [VAR_1] and [VAR_2] will be moderated by [MODERATOR]',
    examples: [
...
export default function HypothesisBuilderPage() {
  ...
  const calculateTestability = (hypothesis: Partial<Hypothesis>) => {
    ...
    if (!hypothesis.statement || hypothesis.statement.length < 20) {
      ...
      suggestions.push(
        'Provide a more specific and detailed hypothesis statement'
      );
      score -= 30;
    }
    ...
    if (
      hypothesis.statement?.includes('might') ||
      hypothesis.statement?.includes('maybe')
    ) {
      issues.push('Hypothesis contains uncertain language');
      suggestions.push(
        'Use definitive language (will/will not) instead of uncertain terms'
      );
      score -= 10;
    }
    ...
    if (!hypothesis.rationale) {
      ...
      suggestions.push(
        'Provide theoretical or empirical justification for your hypothesis'
      );
      score -= 10;
    }
  ...
  const suggestStatisticalTests = (hypothesis: Partial<Hypothesis>) => {
    ...
    if (
      hypothesis.type === 'alternative' ||
      hypothesis.type === 'directional'
    ) {
      if (
        hypothesis.variables?.independent?.length === 1 &&
        hypothesis.variables?.dependent?.length === 1
      ) {
        tests.push(
          'Independent t-test',
          'Mann-Whitney U test',
    ...
    if (
      hypothesis.statement?.toLowerCase().includes('correlation') ||
  ...
  const removeVariable = (
    type: keyof Hypothesis['variables'],
    index: number
  ) => {
    setCurrentHypothesis(prev => ({
      ...prev,
  ...
  const saveHypothesis = () => {
    ...
    const newHypothesis: Hypothesis = {
      ...
      testability:
        ...
        calculateTestability(currentHypothesis),
          ...
          <TabsContent value="builder" className="space-y-6">
            <div className="grid grid-cols-12 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="non-directional">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            setShowVariableHelper(!showVariableHelper)
                          }
                        >
                          ...
                          >
                            <Card className="bg-blue-50 border-blue-200">
                              <CardContent className="p-4 text-sm space-y-2">
                                <p>
                                  <strong>Independent:</strong> The variable you
                                  manipulate or control
                                </p>
                                <p>
                                  <strong>Dependent:</strong> The outcome you
                                  measure
                                </p>
                                <p>
                                  <strong>Control:</strong> Variables held
                                  constant
                                </p>
                                <p>
                                  <strong>Mediating:</strong> Variables that
                                  explain the relationship
                                </p>
                                <p>
                                  <strong>Moderating:</strong> Variables that
                                  affect the strength/direction
                                </p>
                              </CardContent>
                            </Card>
                          </motion.div>
                          ...
                          <div className="flex gap-2 mt-1">
                            <Input
                              ...
                              onKeyPress={e => {
                                if (e.key === 'Enter') {
                                  addVariable(
                                    varType as keyof Hypothesis['variables'],
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const input = document.querySelector(
                                  `input[placeholder="Add ${varType} variable..."]`
                                ) as HTMLInputElement;
                                if (input?.value) {
                                  addVariable(
                                    varType as keyof Hypothesis['variables'],
              ...
              <div className="col-span-4 space-y-4">
                  ...
                  <Card className="border-2 border-purple-200">
                    <CardHeader>
                      <CardTitle className="flex items-center justify-between text-sm">
                        ...
                        <Badge
                          className={cn(
                            currentHypothesis.testability.score >= 80
                              ? 'bg-green-100 text-green-700'
                              : currentHypothesis.testability.score >= 60
                    ...
                    <CardContent className="space-y-3">
                      {currentHypothesis.testability.issues.length > 0 && (
                        <div>
                          ...
                          {currentHypothesis.testability.issues.map(
                            (issue, index) => (
                              <div
                                key={index}
                      ...
                      {currentHypothesis.testability.suggestions.length > 0 && (
                        <div>
                          ...
                          {currentHypothesis.testability.suggestions.map(
                            (suggestion, index) => (
                              <div
                                key={index}
                                className="flex items-start gap-2 text-xs text-blue-600 mb-1"
                              >
                ...
                {/* Suggested Tests */}
                {currentHypothesis.statisticalTests &&
                  currentHypothesis.statisticalTests.length > 0 && (
                    <Card>
                      <CardHeader>
                      ...
                      <CardContent>
                        <div className="space-y-2">
                          {currentHypothesis.statisticalTests.map(
                            (test, index) => (
                              <Badge
                                key={index}
                                variant="outline"
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    {
                      label: 'Clear and specific statement',
                      checked: !!currentHypothesis.statement,
                    },
                    {
                      label: 'Testable and falsifiable',
                      checked: (currentHypothesis.testability?.score || 0) > 60,
                    },
                    {
                      label: 'Variables clearly identified',
                      checked:
                        !!currentHypothesis.variables?.independent?.length,
                    },
                    {
                      label: 'Theoretical rationale provided',
                      checked: !!currentHypothesis.rationale,
                    },
                    {
                      label: 'Statistical tests identified',
                      checked: !!currentHypothesis.statisticalTests?.length,
                    },
                    {
                      label: 'Alternative explanations considered',
                      checked: !!currentHypothesis.alternativeExplanations,
                    },
                  ].map((item, index) => (
                ...
                <Card className="text-center py-12">
                  <CardContent>
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Create your first hypothesis in the Builder tab
                    </p>
                  </CardContent>
                </Card>
              ) : (
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            {hypothesis.testability && (
                              <Badge
                                className={cn(
                                  hypothesis.testability.score >= 80
                                    ? 'bg-green-100 text-green-700'
                                    : hypothesis.testability.score >= 60
                                      ? 'bg-yellow-100 text-yellow-700'
                                      : 'bg-red-100 text-red-700'
                                )}
                              >
