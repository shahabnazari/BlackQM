...
vi.mock('../Illustrations', () => ({
  ...
  NoParticipantsIllustration: () => (
    <div data-testid="no-participants-illustration" />
  ),
  SessionExpiredIllustration: () => (
    <div data-testid="session-expired-illustration" />
  ),
...
describe('EmptyState Components', () => {
  ...
  describe('EmptyState Base Component', () => {
    ...
    it('renders correct illustration for each type', () => {
      ...
      rerender(
        <EmptyState type="no-participants" title="Test" description="Test" />
      );
      expect(
        screen.getByTestId('no-participants-illustration')
      ).toBeInTheDocument();
  ...
  describe('EmptyStudyState Component', () => {
    it('renders with correct title and description', () => {
      ...
      expect(
        screen.getByText(
          /Get started by creating your first Q methodology study/
        )
      ).toBeInTheDocument();
    });
  ...
  describe('EmptyDataState Component', () => {
    it('renders with correct title and description', () => {
      ...
      expect(
        screen.getByText(/Waiting for participants to complete sorts/)
      ).toBeInTheDocument();
    });
  ...
  describe('EmptyParticipantState Component', () => {
    it('renders with correct title and description', () => {
      ...
      expect(
        screen.getByText(/Share your study link to start collecting responses/)
      ).toBeInTheDocument();
    });
