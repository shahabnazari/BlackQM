...
const phases = [
  { id: 1, name: 'DISCOVER', path: '/discover', color: 'from-purple-500 to-purple-600' },
  { id: 2, name: 'DESIGN', path: '/design', color: 'from-indigo-500 to-indigo-600' },
  { id: 3, name: 'BUILD', path: '/studies/create', color: 'from-blue-500 to-blue-600' },
  { id: 4, name: 'RECRUIT', path: '/recruitment', color: 'from-cyan-500 to-cyan-600' },
  { id: 5, name: 'COLLECT', path: '/collect', color: 'from-teal-500 to-teal-600' },
  { id: 6, name: 'ANALYZE', path: '/analysis', color: 'from-green-500 to-green-600' },
  { id: 7, name: 'VISUALIZE', path: '/visualize', color: 'from-lime-500 to-lime-600' },
  { id: 8, name: 'INTERPRET', path: '/interpret', color: 'from-yellow-500 to-yellow-600' },
  { id: 9, name: 'REPORT', path: '/report', color: 'from-orange-500 to-orange-600' },
  { id: 10, name: 'ARCHIVE', path: '/archive', color: 'from-red-500 to-red-600' }
];
...
export function SwipeNavigation({ children, className, enabled = true }: SwipeNavigationProps) {
  ...
  const NavigationButton = ({ direction, onClick }: { direction: 'prev' | 'next', onClick: () => void }) => {
    ...
    const disabled = isPrev ? currentPhaseIndex === 0 : currentPhaseIndex === phases.length - 1;
