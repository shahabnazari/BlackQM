...
const [extractionPurpose, setExtractionPurpose] = useState<ResearchPurpose | null>(null);
const [showPurposeWizard, setShowPurposeWizard] = useState(false);
const [v2SaturationData, setV2SaturationData] = useState<SaturationData | null>(null);
const [userExpertiseLevel, setUserExpertiseLevel] = useState<UserExpertiseLevel>('researcher');
```
